...
int trigid[34];
trigid[0]=16; trigid[1]=18;trigid[2]=20;trigid[3]=21;trigid[4]=22;trigid[5]=23;trigid[6]=24;trigid[7]=29;trigid[8]=30;trigid[9]=31;
trigid[10]=32;trigid[11]=34;trigid[12]=35;trigid[13]=55;trigid[14]=56;trigid[15]=57;trigid[16]=570001;trigid[17]=570004;trigid[18]=570005;
trigid[19]=570006;trigid[20]=570007;trigid[21]=570008;trigid[22]=570015;trigid[23]=570201;trigid[24]=570203;trigid[25]=570204;
trigid[26]=570205;trigid[27]=570209;trigid[28]=570214;trigid[29]=570215;trigid[30]=570401;trigid[31]=570402;
trigid[32]=570403;trigid[33]=570204;
...
{ 
	...
	//if (!ev) continue; 
	//if (fabs(ev->primaryVertex().X()>1. || fabs(ev->primaryVertex().Y()>1.))) continue; 
	...
	{if ((ev->isTrigger(trigid[trig]))) int ftrigger = trigid[trig];} //diffrent in pico and Mudst format
	...
	//	{
			...
			if(trackTofIndex >= 0)  fBetaToF[fTrackCounter]  = pico->btofPidTraits(trackTofIndex)->btofBeta(); 
			fTrackCounter++ ;
